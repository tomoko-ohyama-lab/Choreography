...
clear all
figureName='Basin2-Basin4-LED30';
chore = {'kink'}; % SET MANUALLY
choredir = 'C:\Users\Ohyama_Dell\Documents\choreography_results\t93'; % SET MANUALLY
    % choredir = folder location where all genotypes are stored
    %         ~= folder location of specific genotype
outdir = 'C:\Users\Ohyama_Dell\Documents\figures'; % SET MANUALLY
...
for ii = 1:length(uname)
    ...
    xlim([0 (stimint+stimdur*2+waiting*2)])
